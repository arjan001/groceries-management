...
export default function POSPage() {
  ...
  const [receiptSettings, setReceiptSettings] = useState<ReceiptSettings>({
    headerText: 'SNACKOH GROCERY SYSTEM', subHeaderText: 'Quality Groceries', footerText: 'Thank you for choosing Snackoh!',
  ...
  const [paymentDetailsSettings, setPaymentDetailsSettings] = useState<PaymentDetailsSettings>({
    mpesaType: 'paybill', paybillNumber: '', accountNumber: '', tillNumber: '', mpesaName: 'SNACKOH GROCERY SYSTEM', showOnReceipt: true,
    bankName: '', bankAccount: '', bankBranch: '',
  });
  const [generalSettings, setGeneralSettings] = useState<GeneralSettings>({
    businessName: 'SNACKOH GROCERY SYSTEM', phone: '+254 700 000 000', email: 'info@snackoh.com', shopNumber: '', address: 'Nairobi, Kenya', currency: 'KES', taxRate: 16, logoUrl: '',
  });
