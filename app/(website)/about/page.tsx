    ...
    <div className="bg-white">
      ...
      <section className="relative bg-gray-950 text-white py-20 md:py-28">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <p className="text-xs text-orange-400 font-bold tracking-widest uppercase mb-3">About FreshCart Groceries</p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-sm text-gray-600 leading-relaxed">
                <p>
                  FreshCart Groceries was born out of a simple belief: everyone deserves access to fresh, high-quality groceries sourced with care. What started as a small neighbourhood grocery store has grown into a trusted name across Nairobi.
                </p>
                <p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-2 text-sm max-w-2xl mx-auto">
              Whether you&apos;re buying for your family or stocking your business, FreshCart Groceries has you covered with competitive pricing and consistent quality.
            </p>
          </div>
