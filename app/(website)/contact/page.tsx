    ...
    <div className="bg-white">
      ...
      <section className="bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
          <p className="text-xs text-green-400 font-bold tracking-widest uppercase mb-2">Get In Touch</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow text-center">
              ...
              <a href="tel:0733675267" className="text-green-600 font-bold text-lg hover:underline block mb-2">
                0733 67 52 67
              </a>
              <a href="mailto:sales@snackoh-groceries.com" className="text-gray-600 text-sm hover:text-green-600 transition-colors">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow text-center">
              ...
              <a href="tel:0722587222" className="text-green-600 font-bold text-lg hover:underline block mb-1">
                0722 587 222
              </a>
              <a href="tel:0799559434" className="text-green-600 font-bold text-lg hover:underline block mb-2">
                0799 55 94 34
              </a>
              <a href="mailto:feedback@snackoh-groceries.com" className="text-gray-600 text-sm hover:text-green-600 transition-colors">
                feedback@snackoh-groceries.com
              </a>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow text-center">
              ...
              <a href="mailto:ceo@snackoh-groceries.com" className="text-gray-600 text-sm hover:text-green-600 transition-colors block mb-1">
                ceo@snackoh-groceries.com
              </a>
              <a href="mailto:sales@snackoh-groceries.com" className="text-gray-600 text-sm hover:text-green-600 transition-colors block">
                sales@snackoh-groceries.com
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-xs text-green-600 font-bold tracking-widest uppercase mb-1">All Contact Details</p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="tel:0733675267" className="text-gray-800 font-semibold hover:text-green-600 transition-colors">
                    0733 67 52 67
                  </a>
                </div>
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">Complaints & Compliments</p>
                  <a href="tel:0722587222" className="text-gray-800 font-semibold hover:text-green-600 transition-colors block">
                    0722 587 222
                  </a>
                  <a href="tel:0799559434" className="text-gray-800 font-semibold hover:text-green-600 transition-colors block mt-1">
                    0799 55 94 34
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:sales@snackoh-groceries.com" className="text-gray-800 font-semibold hover:text-green-600 transition-colors">
                    sales@snackoh-groceries.com
                  </a>
                </div>
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">Leadership</p>
                  <a href="mailto:ceo@snackoh-groceries.com" className="text-gray-800 font-semibold hover:text-green-600 transition-colors">
                    ceo@snackoh-groceries.com
                  </a>
                </div>
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mb-1">Feedback</p>
                  <a href="mailto:feedback@snackoh-groceries.com" className="text-gray-800 font-semibold hover:text-green-600 transition-colors">
                    feedback@snackoh-groceries.com
                  </a>
                </div>
              </div>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/shop"
              className="px-8 py-3.5 bg-green-600 text-white font-bold text-sm rounded-full hover:bg-green-700 transition-colors">
              Shop Now
            </Link>
            <a href="tel:0733675267"
              className="px-8 py-3.5 border-2 border-gray-200 text-gray-800 font-bold text-sm rounded-full hover:border-green-400 hover:text-green-600 transition-colors">
              Call to Order
            </a>
          </div>
        </div>
